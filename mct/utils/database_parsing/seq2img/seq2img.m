function seq2img(camera, start_frame, end_frame)
    ...
    input_seq_file = strcat('/media/pedro/mct1//HDA_Dataset_V1.3/hda_image_sequences_matlab/camera', num2str(camera), '.seq');
    output_directory = strcat('/media/pedro/mct1/HDA_Dataset_V1.3/images/cam', num2str(camera), '/');
