...
% TODO Apply gating here -- that is separate score matrix creation and solving the algorithm into 2 distinct function
...
% We need to add the region to the estimation of the homography
...
new_Hs{2} = solve_homography(transpose(c2_points(:,1:2)),w,'svd');
% --------------------------------------------------------------------------
% cvx_begin
